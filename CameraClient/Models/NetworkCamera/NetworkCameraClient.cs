...
using CameraClient.Models.NetworkCamera.RawFramesReceiving;
using HalationGhost;
...
namespace CameraClient.Models.NetworkCamera
{
    public class NetworkCameraClient : BindableModelBase, ICameraClient
    {
        ...
        public NetworkCameraClient(CameraSetting cameraSetting)
        {
            this._realtimeVideoSource = new RealtimeVideoSource(cameraSetting.RecordedFrameFolder);
        ...
        public async Task<List<OnvifNetworkCameraProfile>> GetCameraDeviceInfoAsync(string host, string userName, string password)
        {
            ...
            foreach (var profile in profiles.Profiles)
            {
                ...
                try
                {
                    ...
                    cameraProfile.BitRateLimit = videoEncoderConfig.RateControl.BitrateLimit;
